"""
# Process Vaisala PTB110 barometric pressure sensor data to netCDF (STFC variant)
"""
...
def main():
    """CLI entry point for process-ptb110-stfc command."""
    import argparse
    parser = argparse.ArgumentParser(description="Process Vaisala PTB110 barometric pressure data (STFC variant) to netCDF")

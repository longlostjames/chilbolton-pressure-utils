#!/usr/bin/env python3
"""Process a single month of PTB110 pressure data from STFC variant."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process a single month of PTB110 barometric pressure data from STFC variant.",
    )

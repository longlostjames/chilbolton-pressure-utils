#!/usr/bin/env python3
"""Process a full year of PTB110 pressure data from CR1000X format."""
...
def main():
    """Process a full year of PTB110 pressure data."""
    parser = argparse.ArgumentParser(
        description="Process a full year of PTB110 barometric pressure data from CR1000X format.",
        epilog="""This command processes an entire year of Vaisala PTB110 barometric pressure
